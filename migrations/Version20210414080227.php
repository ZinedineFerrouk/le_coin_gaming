 ...
 */
<<<<<<< HEAD:migrations/Version20210414083946.php
final class Version20210414083946 extends AbstractMigration
=======
final class Version20210414080227 extends AbstractMigration
>>>>>>> 424bc4ed15835389c70d931d56ca01b2dc9d85f6:migrations/Version20210414080227.php
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, pseudo VARCHAR(50) NOT NULL, num INT DEFAULT NULL, age INT NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
